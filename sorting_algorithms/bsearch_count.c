// Binary search with number of total comparisions made to find the given element.
...
int search(int arr[], int size, int key)
{
  ...
  while (low <= high)
  {
    total_comparisons++; // the total number of comparisons to find the given number.
...
int main()
{
  ...
  printf("\n The total number of comparisons are %d", total_comparisons);
